...
--
-- Host: localhost
-- Generation Time: Mar 01, 2014 at 06:48 PM
...
CREATE TABLE `A2bs` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_A2BS_RESOURCES1_idx` (`resource_id`),
  KEY `fk_A2B_WORLD2_idx` (`from`),
  KEY `fk_A2B_WORLD1_idx` (`to`),
  KEY `finish` (`finish`)
...
CREATE TABLE `Assists` (
  ...
  KEY `fk_ASSISTS_RESOURCES_idx` (`resource_id`),
...
CREATE TABLE `Camps` (
  ...
  `prod1` mediumint(9) DEFAULT NULL,
  `prod2` mediumint(9) DEFAULT NULL,
  `prod3` mediumint(9) DEFAULT NULL,
  `unread_reports` smallint(5) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_CAMPS_WORLD_idx` (`world_id`),
  KEY `fk_CAMPS_USERS1_idx` (`user_id`),
  KEY `fk_CAMPS_RESOURCES1_idx` (`resource_id`)
...
INSERT INTO `Camps` (`id`, `world_id`, `user_id`, `resource_id`, `name`, `pts`, `type`, `loyalty`, `last_update`, `created`, `prod1`, `prod2`, `prod3`, `unread_reports`) VALUES
(1, 19754, 1, 1, 'Default', 0, 0, 0.00, 1393696022, '2014-03-01 18:47:02', 20, 10, 0, 0);
...
CREATE TABLE `Camps_Units` (
  ...
  `unit_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_CAMPS_UNITS_CAMPS1_idx` (`camp_id`),
  KEY `fk_CAMPS_UNITS_UNITS1_idx` (`unit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
INSERT INTO `Resources` (`id`, `res1`, `res2`, `res3`) VALUES
(1, 500.0000, 300.0000, 50.0000);
...
CREATE TABLE `Teams` (
  ...
  KEY `fk_TEAMS_USERS1_idx` (`created_by`),
...
INSERT INTO `Users` (`id`, `username`, `password`, `email`, `access`, `desc`, `diam`, `plus`, `token`, `last_update`, `created`, `team_id`, `team_access`, `biskanah`, `rank_pts`, `rank_units`, `unread_msg`) VALUES
(1, 'Tamazy', '866b712159a181c7af436bb73d350e17fd45a9c5', 'tamazy@laposte.net', 0, '', 0, 0, '', 0, '2014-03-01 18:47:02', NULL, NULL, 0, 0, 0, 0);
...
INSERT INTO `Worlds` (`id`, `x`, `y`, `type`, `occupied`) VALUES
(1, -100, -100, 0, 0),
(2, -100, -99, 0, 0),
(3, -100, -98, 0, 0),
(4, -100, -97, 0, 0),
...
--
ALTER TABLE `A2bs`
  ADD CONSTRAINT `fk_A2B_WORLD1` FOREIGN KEY (`to`) REFERENCES `Camps` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_A2B_WORLD2` FOREIGN KEY (`from`) REFERENCES `Camps` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_A2BS_RESOURCES1` FOREIGN KEY (`resource_id`) REFERENCES `Resources` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `Assists`
  ADD CONSTRAINT `fk_ASSISTS_CAMPS_FROM` FOREIGN KEY (`from`) REFERENCES `Camps` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ASSISTS_RESOURCES` FOREIGN KEY (`resource_id`) REFERENCES `Resources` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ASSISTS_CAMPS_ON` FOREIGN KEY (`on`) REFERENCES `Camps` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `Camps`
  ...
  ADD CONSTRAINT `fk_CAMPS_RESOURCES1` FOREIGN KEY (`resource_id`) REFERENCES `Resources` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `Teams`
  ADD CONSTRAINT `fk_TEAMS_USERS1` FOREIGN KEY (`created_by`) REFERENCES `Users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
