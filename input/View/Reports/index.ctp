<div class="reports index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('pts_att'); ?></th>
			<th><?php echo $this->Paginator->sort('pts_def'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($report['Report']['read']); ?>&nbsp;</td>
		<td><?php echo h($report['Report']['pts_att']); ?>&nbsp;</td>
		<td><?php echo h($report['Report']['pts_def']); ?>&nbsp;</td>
		<td><?php echo h($report['Report']['archive']); ?>&nbsp;</td>
		<td class="actions">
