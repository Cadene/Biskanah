<div class="campsUnits index">
	<h2><?php echo __('Camps Units'); ?></h2>
	...
	<?php foreach ($campsUnits as $campsUnit): ?>
	<tr>
		<td><?php echo h($campsUnit['CampsUnit']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $campsUnit['CampsUnit']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $campsUnit['CampsUnit']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $campsUnit['CampsUnit']['id']), null, __('Are you sure you want to delete # %s?', $campsUnit['CampsUnit']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
