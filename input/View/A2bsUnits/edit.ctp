...
<?php echo $this->Form->create('A2bsUnit'); ?>
	<fieldset>
		<legend><?php echo __('Edit A2bs Unit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('A2bsUnit.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('A2bsUnit.id'))); ?></li>
