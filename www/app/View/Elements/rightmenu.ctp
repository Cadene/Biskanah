...
<div class="lm_md lm_ctot">
    ...
    <div id="lm_navig_cat" class="lm_hs">
        <div class="lm_smcu">Nom : Tamazy</div>
        <div class="lm_smcu">Points : 135067</div>
        <div class="lm_smcu">Classement : 1er</div>
        <br>
    </div>
    ...
    <div id="lm_navig_cat" class="lm_hs">
        <div class="lm_smcu">Nom : Space Pirate</div>
        <div class="lm_smcu">Points : 135067</div>
        <div class="lm_smcu">Classement : 1er</div>
        <br>
    </div>
    ...
    <div id="lm_navig_cat" class="lm_hs">
        <div class="lm_smcu">Nom : Phobia</div>
        <div class="lm_smcu">Cases : 10/30</div>
        <div class="lm_smcu">
            <div class="default_1c1">
                ...
                <div class="default_1c1b" style="overflow:visible;" id="ov_metal">
                    <a href="#" title="2.780290261E+11"><font color="#7BE654">10.000.000.000</font></a>
                </div>
            </div>
        </div>
        <div class="lm_smcu">
            <div class="default_1c2">
                <div class="default_1c1a curvedtot"><div class="default_head_img dhi3" title="Cristal"></div></div>
                <div class="default_1c1b" style="overflow:auto;" id="ov_cristal">
                    <a href="#" title="6.544852447E+10"><font color="#7BE654">65.448.524.474</font></a>
                </div>
            </div>
        </div>
        <div class="lm_smcu">
            <div class="default_1c3">
                <div class="default_1c1a curvedtot"><div class="default_head_img dhi1" title="Deut&eacute;rium"></div></div>
                <div class="default_1c1b" style="overflow:auto;" id="ov_deuterium">
                    <a href="#" title="3.968553836E+10"><font color="#7BE654">39.685.538.363</font></a>
                </div>
            </div>
        </div>
        <div class="lm_smcu">
            <div class="default_1b1 curvedtot">
                <form action="" method="get" id="changeplanet" name="changeplanet">
                    ...
                    <select name="cp" id="cp" size="1" onchange="javascript:document.forms[0].submit();">
                        <option value="3201" style="font-weight:bold;" selected="selected">(-10;16)&nbsp;Phobia</option>
                        <option value="3201" style="font-weight:bold;">(-10;18)&nbsp;Pumphonia</option>
                    </select>
    ...
    <div id="lm_navig_cat" class="lm_hs">
        <div class="lm_smcu">Scout : 100</div>
        <div class="lm_smcu">Medic : 348</div>
        <div class="lm_smcu">Recon : 192</div>
    </div>
    <br>
