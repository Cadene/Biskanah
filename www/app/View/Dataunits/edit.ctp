...
<?php echo $this->Form->create('Dataunit'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dataunit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Dataunit.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Dataunit.id'))); ?></li>
