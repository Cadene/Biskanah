...
<?php echo $this->Form->create('Dttechno'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dttechno'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Dttechno.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Dttechno.id'))); ?></li>
